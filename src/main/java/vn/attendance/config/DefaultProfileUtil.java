 ...
 * If the value is not available in {@code application-dev.yml} then {@code dev} profile will be used as default.
 */
public final class DefaultProfileUtil {
    ...
    public static void addDefaultProfile(SpringApplication app) {
         ...
         * This cannot be set in the application-dev.yml file.
