package vn.attendance.config.quartz;
...
//		factoryBean.setGroup("SampleGroup");
        try {
            factoryBean.afterPropertiesSet();
     ...
     * @return Trigger
     */
    protected static Trigger createCronTrigger(String triggerName, String triggerGroup, Date startTime, String cronExpression,
                                               int misFireInstruction) {
        PersistableCronTriggerFactoryBean factoryBean = new PersistableCronTriggerFactoryBean();
        factoryBean.setName(triggerName);
        factoryBean.setStartTime(startTime);
