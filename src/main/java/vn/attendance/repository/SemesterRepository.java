...
public interface SemesterRepository extends JpaRepository<Semester, Integer> {
    ...
    @Query("SELECT new vn.attendance.service.semester.service.response.SemesterDto(s.id, " +
            ...
            "WHERE (:search IS NULL OR s.semesterName LIKE CONCAT('%', :search, '%')) " +
            "ORDER BY s.createdAt DESC")
    Page<SemesterDto> searchSemester(@Param("search") String search, Pageable pageable);
